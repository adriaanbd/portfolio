...
export const aboutData = {
  img: 'avatar.jpeg',
  paragraphOne:
    'I’m a former law and music major turned full-stack developer with a creative, resilient, and problem-solving attitude. My journey in software development started when I taught myself programming by creating a Python script that automated a business task with a 95% time savings benefit for Thomson Reuters. I transitioned from an operations role into a more technical role to lead requirements gathering & analysis meetings, and produce automation scripts with an internationally located and cross-functional team.',
  paragraphTwo:
    'I’ve mentored hundreds of people and reviewed over 200 full-stack development projects for two major tech education companies while learning data structures and algorithms, full-stack development and building over 30 projects including a Facebook replica, a vitals tracking mobile web app, a healthcare mobile app, a battleship game, and a Newsweek replica, among others. In addition, I’ve also been a Python Instructor in an introductory Python workshop to school teachers in Panama, and in an introduction to Django workshop to college students.',
  paragraphThree:
